...
create_real_instruments_from_data <- function(epc_data) {
  cat("Creating real multidimensional instruments from EPC data patterns...\n")
...
create_composite_instruments <- function(instruments) {
  cat("Creating composite instruments using factor analysis and scaling...\n")
...
merge_epc_with_created_instruments <- function(epc_data, instruments) {
  cat("Merging EPC data with created instruments...\n")
